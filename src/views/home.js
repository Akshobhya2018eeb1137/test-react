...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Blue Dear Porpoise</title>
        <meta property="og:title" content="Blue Dear Porpoise" />
      </Helmet>
      <input
        type="text"
      ...
      <div className="home-blog-post-card2">
        <img
          alt="image"
          src="/logo-without-bg-400h.png"
          className="home-image3"
        />
      </div>
      <header data-thq="thq-navbar" className="home-navbar-interactive">
        <Link to="/" className="home-navlink1">
          <img alt="logo" src="/logo-wtih-bg-1500h.png" className="home-logo" />
        </Link>
        <div
        ...
        >
          ...
          >
            <Link to="/">Home</Link>
            <Link to="/about" className="home-navlink3">
              About
            </Link>
            <Link to="/pricing" className="home-navlink4">
              Pricing
            </Link>
            <Link to="/team" className="home-navlink5">
              Team
            </Link>
          </nav>
        </div>
